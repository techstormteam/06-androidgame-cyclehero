...
import com.android.androidgames.framework.math.OverlapTester;
import com.android.androidgames.framework.math.Vector2;
import com.android.androidgames.gamedev2d.Cannon;
import com.android.androidgames.gamedev2d.DynamicGameObject;
import com.android.androidgames.gamedev2d.GameObject;
import com.techstorm.androidgame.framework.Game;
import com.techstorm.androidgame.framework.Input.TouchEvent;
...
public class CollisionScreen extends Screen {
	...
	public CollisionScreen(Game game) {
		...
		for(int i = 0; i < NUM_TARGETS; i++) {
			GameObject target = new GameObject((float)Math.random() * WIDTH, (float)Math.random() * HEIGHT,
					0.5f, 0.5f);
